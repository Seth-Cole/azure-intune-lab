...
## Monitored Settings
- Required Device Encryption – Ensures BitLocker is enabled and deployed for attached disks to impliment full disk encryption for each device, this includes OS, removable, and fixed data drives. This hardens the security posture by protecting data stored on disk incase of loss of equipment, or stolen disks.
